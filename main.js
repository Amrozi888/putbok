...
global.prefix = new RegExp('^[' + (opts['prefix'] || '‎xzXZ/!#$%+£¢€¥^°=¶∆×÷π√✓©️®️:;?&,.\\-').replace(/[|\\{}()[\]^$+*?.\-\^]/g, '\\$&') + ']')
...
global.db = new Low(new mongoDB('mongodb+srv://zifabotz:zifabotz01cluster0.yr4o3.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'))
